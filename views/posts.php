    ...
    <main>
        <div class="tbody" style="text-align: center;">
            ...
            foreach ($posts as $post) { ?>
                <a href="post.php?id=<?php echo $post['id'] ?>"><img class="post" src="img/posts/<?php echo $post['image']; ?>"
                        height=200 width=150 style="object-fit: contain;"></a>
    ...
    <div class="paginador" style="text-align: center;">
        <p>
            ...
            <?php for ($i = 1; $i <= ceil(intval($cant["c"]) / 4); $i++) { ?>
                <a
                    href="posts.php?pag=<?php echo $i; ?>&tag=<?php echo $_GET['tag'] ?>"><button class="ace"><?php echo $i; ?></button></a>
            <?php } ?>

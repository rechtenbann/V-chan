...
if (isset($_POST['nombre']) && isset($_POST['email']) && isset($_POST['contra'])) {
    ...
    $sql = "INSERT INTO usuarios (id,usu_nombre,usu_clave,usu_email,foto_perfil,nsfw_allow, dark_mode,fecha_alta,fecha_baja) VALUES (null,'" . $_POST['nombre'] . "','" . $pass . "','" . ($_POST['email']) . "','default1.png', 0, 0,NOW(),null)";
